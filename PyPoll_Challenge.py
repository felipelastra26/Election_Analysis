...
file_to_load = os.path.join("/Users/felipelastra/Library/CloudStorage/OneDrive-Personal/Analytics/Module3/Election_Analysis//Resources/election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if votes_county > county_largest_count and county_percentage > county_largest_pct:
            county_largest_turnout = county_name
            county_largest_count = votes_county
            county_largest_pct = county_percentage
